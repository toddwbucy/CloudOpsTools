...
PCM-Ops Tools is a unified multi-cloud operations platform built with FastAPI. The application serves both REST API endpoints and a web interface from a single process on port 8500. It's designed for standardizing operations across AWS, Azure, GCP, and ServiceNow.
...
- Standard logger names: `pcm_ops_tools.{module}`
